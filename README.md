This repository contains the code for an AI-powered medical chatbot. The chatbot is designed to provide users with medical information and advice based on their queries.
